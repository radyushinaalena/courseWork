public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees[0] = new Employee("Иванов Иван Иванович", 1, 33333);
        employees[1] = new Employee("Петров Петр Петрович", 2, 222222);
        employees[2] = new Employee("Арбузов Игорь Семенович", 3, 33333);
